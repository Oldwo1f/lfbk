angular.module('momi-params')
  .directive('paramsList', ["articleService", "paramsService", function (articleService,paramsService){
    ...
    return {
		...
		controller:["$scope", "$rootScope", "userService", "$filter", "articleService", "paramsService", "tagService", "imageService", "documentService", "$sailsSocket", "$stateParams", "$state", "usSpinnerService", function($scope,$rootScope,userService,$filter,articleService,paramsService,tagService,imageService,documentService,$sailsSocket,$stateParams,$state,usSpinnerService){
