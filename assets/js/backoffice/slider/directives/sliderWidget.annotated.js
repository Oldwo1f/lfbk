angular.module('momi-sliders')
  .directive('sliderWidget', ["widgetService", "sliderService", "$state", function (widgetService,sliderService,$state){
    ...
    return {
      ...
      controller:["$scope", "sliderService", "$state", function($scope,sliderService,$state){
